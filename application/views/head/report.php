...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Laporan Logbook Unit</h3>
    </div>
    <div class="card-body">
        ...
        <div class="mb-3">
            <a href="<?php echo base_url(); ?>head/export?type=excel&start_date=<?php echo htmlspecialchars($data['start_date'], ENT_QUOTES, 'UTF-8'); ?>&end_date=<?php echo htmlspecialchars($data['end_date'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-success" target="_blank">
                <i class="fas fa-file-excel"></i> Export Excel
            </a>
            <a href="<?php echo base_url(); ?>head/export?type=pdf&start_date=<?php echo htmlspecialchars($data['start_date'], ENT_QUOTES, 'UTF-8'); ?>&end_date=<?php echo htmlspecialchars($data['end_date'], ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-danger" target="_blank">
    ...
    <div class="card-footer clearfix">
        <ul class="pagination pagination-sm m-0 float-right">
            <?php if ($data['page'] > 1): ?>
                <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>head/report?page=<?php echo $data['page'] - 1; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>">&laquo;</a></li>
            <?php endif; ?>
            
            <?php for($i = 1; $i <= $data['total_pages']; $i++): ?>
                <li class="page-item <?php echo ($data['page'] == $i) ? 'active' : ''; ?>">
                    <a class="page-link" href="<?php echo base_url(); ?>head/report?page=<?php echo $i; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>"><?php echo $i; ?></a>
                </li>
            <?php endfor; ?>
            
            <?php if ($data['page'] < $data['total_pages']): ?>
                <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>head/report?page=<?php echo $data['page'] + 1; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>">&raquo;</a></li>
            <?php endif; ?>
        </ul>
    </div>
</div>
