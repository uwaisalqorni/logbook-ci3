...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Riwayat Logbook Head</h3>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>head/logbook?date=<?php echo $logbook['date']; ?>" class="btn btn-sm btn-primary">
    ...
    <div class="card-footer clearfix">
        <ul class="pagination pagination-sm m-0 float-right">
            <?php if ($data['page'] > 1): ?>
                <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>head/history?page=<?php echo $data['page'] - 1; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>">&laquo;</a></li>
            <?php endif; ?>
            
            <?php for($i = 1; $i <= $data['total_pages']; $i++): ?>
                <li class="page-item <?php echo ($data['page'] == $i) ? 'active' : ''; ?>">
                    <a class="page-link" href="<?php echo base_url(); ?>head/history?page=<?php echo $i; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>"><?php echo $i; ?></a>
                </li>
            <?php endfor; ?>
            
            <?php if ($data['page'] < $data['total_pages']): ?>
                <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>head/history?page=<?php echo $data['page'] + 1; ?>&start_date=<?php echo $data['start_date']; ?>&end_date=<?php echo $data['end_date']; ?>">&raquo;</a></li>
            <?php endif; ?>
        </ul>
    </div>
</div>
