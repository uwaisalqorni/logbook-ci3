...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Daftar Logbook Head Menunggu Validasi</h3>
    </div>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>kabid/detail/<?php echo $logbook['id']; ?>" class="btn btn-sm btn-primary">Validasi</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>kabid/detail/<?php echo $logbook['id']; ?>" class="btn btn-sm btn-info">Lihat</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
